...
GOOGLE = {
    ...
    "reel_beats": {
        ...
        "body": [
            ...
            {"text": "It guesses what you meant, so it buys anything close to your words.",
             "emphasis": "guesses"},
            {"text": "About a third of the average budget goes to those near-misses, every month.",
             "emphasis": "a third"},
            {"text": "Open your search terms report, and block every search that never sold anything.",
             "emphasis": "block every search"},
        ],
    ...
    "reel_beats": {
        ...
        "body": [
            {"text": "Facebook spends the first week working out who actually buys from you.",
             "emphasis": "first week"},
            {"text": "Change the budget or the image, and it throws that week away and starts again.",
             "emphasis": "starts again"},
            {"text": "Accounts that get fiddled with weekly never finish learning, so they stay dear.",
             "emphasis": "never finish"},
            {"text": "Leave a new campaign alone for seven days, then judge it on day fourteen.",
             "emphasis": "day fourteen"},
        ],
...
EMAIL = {
    ...
    "reel_beats": {
        ...
        "body": [
            ...
            {"text": "By then they have bought somewhere else, or forgotten the basket completely.",
             "emphasis": "bought somewhere else"},
            {"text": "That wait costs about one basket in eight that you could still have won.",
             "emphasis": "one basket in eight"},
            {"text": "Send the first email one hour after they leave, while they still want it.",
             "emphasis": "one hour"},
        ],
